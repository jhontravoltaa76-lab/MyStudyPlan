...
class _ProfileScreenState extends State<ProfileScreen> {
  ...
  void initState() {
    ...
    _institusiController = TextEditingController(
      text: widget.userData['institusi'],
    );
    _nomorIdController = TextEditingController(
      text: widget.userData['nomorId'],
    );
  ...
  Future<void> _kirimResetPassword() async {
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
        content: Text("Mengirim email...", style: GoogleFonts.outfit()),
